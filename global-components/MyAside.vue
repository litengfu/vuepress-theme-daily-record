<template>
  <el-aside class="menu" width="auto" :class="{ menuHide: isHide }">
    <el-menu @select="select" :default-active="$route.path.slice(0, 7)" active-text-color="#3f51b5" class="menu-wrap">
      <li>
        <div class="brand-wrap" :style="{backgroundImage : `url(${$withBase($themeConfig.brand || '')})`}">
          <div class="brand">
            ...
            <hgroup class="introduce">
              ...
              <a :title="$themeConfig.email || '没有email'" class="mail">{{$themeConfig.email || '没有email'}}</a>
            </hgroup>
          </div>
        </div>
      </li>
